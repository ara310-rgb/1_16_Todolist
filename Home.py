...
st.markdown("""
    ...
    .notice-container {
        ...
        border-radius: 16px; padding: 30px 35px; margin-top: 40px;
        position: relative;
    }
    .notice-header { display: flex; align-items: center; gap: 10px; margin-bottom: 16px; color: #1e293b; }
    .notice-icon { font-size: 20px; }
    .notice-title-text { font-size: 18px; font-weight: 700; letter-spacing: -0.5px; }
    .notice-body { font-size: 15px; color: #475569; line-height: 1.8; word-break: keep-all; font-weight: 400; }
    .notice-highlight { color: #007bff; font-weight: 600; }
    </style>
...
<div class="fixed-layout-container">
    <div class="notice-container">
        ...
        <div class="notice-body">
            본 서비스는 기업의 수출 역량을 객관적으로 진단하기 위해 <span class="notice-highlight">"신용정보의 이용 및 보호에 관한 법률"</span>을 준수합니다.
            입력하신 모든 정보는 암호화되어 안전하게 관리되며, 보다 정밀한 진단 리포트 생성을 위해 적법한 절차에 따라 활용됩니다.
